...
function row(n, meta, onClick, current){
  ...
  b.appendChild(l);
  /* THE SYSTEM NAME IS NOT REPEATED HERE. Every MIG row used to carry the name
     of its planetary system under the region's own name — TRAPPIST-1 beneath
     PHILOSOPHY — while the sky already writes that name under the world itself.
     Saying it twice made the menu look like it held two facts where it held
     one. It is still drawn in the sky, where it belongs: beside the thing it
     names. */
