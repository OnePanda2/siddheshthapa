...
var MIG_SYSTEM={ 'philosophy':'TRAPPIST-1', 'love':'Kepler-16', 'movies':'HR 8799',
                 'life':'Kepler-33', 'technology':'GJ 876' };
...
/* the radius of a world's outermost measured orbit, in scene units */
function outerOrbit(mid,tpl){
  if(!tpl||!tpl.semiMajorAxisAU||!tpl.semiMajorAxisAU.length) return 0;
  var a=tpl.semiMajorAxisAU;
  return scaleFor(mid)*(a[a.length-1]/a[0]);
}
